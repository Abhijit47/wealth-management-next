    ...
    <>
      <div className='service-block bg-surface lg:py-[100px] sm:py-16 py-10'>
        <div className='container'>
          <TextHeadingItem
            style='md:w-3/4 w-full'
            title='Our Services'
            desc='Online banking allows you to manage your finances from anywhere, anytime. You can access your bank account, check your balance, view transactions, and transfer money without having to visit a physical bank.'
          />
