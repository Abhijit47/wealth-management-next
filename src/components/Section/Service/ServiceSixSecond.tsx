          ...
          <div className='list-service grid xl:grid-cols-3 sm:grid-cols-2 gap-8 gap-y-20 mt-20'>
            <div className='service-item rounded-2xl border border-line hover-box-shadow'>
              <div className='service-item-main block h-full px-8 pb-7 md:pt-12 pt-8'>
                ...
                <div className='text-placehover mt-3'>
                  We understand your business requirements and goals, analyzing
                  challenges and opportunities to devise an effective blockchain
                  strategy.
                </div>
              </div>
            </div>
            <div className='service-item rounded-2xl border border-line hover-box-shadow'>
              <div className='service-item-main block h-full px-8 pb-7 md:pt-12 pt-8'>
                ...
                <div className='text-placehover mt-3'>
                  We develop a tailored plan and roadmap, defining objectives,
                  timelines, and milestones for successful implementation
                </div>
              </div>
            </div>
            <div className='service-item rounded-2xl border border-line hover-box-shadow'>
              <div className='service-item-main block h-full px-8 pb-7 md:pt-12 pt-8'>
                ...
                <div className='text-placehover mt-3'>
                  Our skilled team creates robust and scalable blockchain
                  solutions, including smart contracts and decentralized
                  applications (DApps).
                </div>
              </div>
            </div>
            <div className='service-item rounded-2xl border border-line hover-box-shadow'>
              <div className='service-item-main block h-full px-8 pb-7 md:pt-12 pt-8'>
                ...
                <div className='text-placehover mt-3'>
                  We deploy your blockchain solution securely, integrate it into
                  your infrastructure, provide training, and offer ongoing
