      ...
      {style === 'style-one' && (
        <div className='service-item p-8 bg-white rounded-lg border border-line hover-box-shadow'>
          <Link
            ...
            href={'#'}
            as={`/service/service-detail/${data.title
              .toLowerCase()
              .replace(/ /g, '-')}`}>
        ...
        <div className='service-item px-8 py-10 bg-white rounded-lg'>
          <Link
            ...
            as={`/service/service-detail/${data.title
              ...
              .replace(/ /g, '-')}`}>
            <i
              className={`${data.icon} text-gradient md:text-6xl text-5xl`}></i>
      ...
      {style === 'style-four' && (
        <div className='service-item p-8 bg-white rounded-lg border border-line hover-box-shadow'>
          <Link
            ...
            <div className='text-secondary mt-2'>{data.desc}</div>
            <div className='text-button-sm hover:text-success underline inline-block duration-300 mt-3'>
              Read More
            </div>
          </Link>
        </div>
