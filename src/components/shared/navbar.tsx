                  ...
                  {navlinks.map((navlink) => (
                    <li
                      ...
                      className={classNames(
                        'nav-item text-white h-full flex items-center justify-center home',
                        pathname === '/' || pathname.includes(navlink.href)
                          ? 'active'
                          : ''
                      ...
                      <Link
                        href={navlink.href}
                        className='text-white hover:text-primary-dark transition-colors duration-300'>
                        {navlink.label}
                      </Link>
                    </li>
                  ))}
                ...
                {/* <ul className='menu-nav flex items-center xl:gap-2 h-full'>
                  <li
                    ...
                    <ul className='sub-nav'>
                      ...
                      <li
                        className={`sub-nav-item text-black ${
                          pathname === '/homepages/home5' ? 'active' : ''
                        }`}>
                        <Link
                          className='sub-nav-link font-medium'
                      ...
                      <li
                        className={`sub-nav-item text-black ${
                          pathname === '/homepages/home6' ? 'active' : ''
                        }`}>
                        <Link
                          className='sub-nav-link font-medium'
                  ...
                  <li
                    ...
                    <ul className='sub-nav'>
                      ...
                      <li
                        className={`sub-nav-item text-black ${
                          pathname.includes('/case-studies/detail')
                            ? 'active'
                            : ''
                        }`}>
                        <Link
                  ...
                  <li
                    ...
                    <ul className='sub-nav'>
                      ...
                      <li
                        className={`sub-nav-item text-black ${
                          pathname.includes('/blog/blog-detail-one')
                            ? 'active'
                            : ''
                        }`}>
                        <Link
                      ...
                      <li
                        className={`sub-nav-item text-black ${
                          pathname.includes('/blog/blog-detail-two')
                            ? 'active'
                            : ''
                        }`}>
                        <Link
              ...
              <ul className='menu-nav-mobile h-full pt-1 pb-1'>
                {navlinks.map((navlink) => (
                  <li
                    key={navlink.id}
                    className={classNames(
                      'nav-item-mobile h-full flex items-center gap-2 pt-4 pb-2 pl-3 pr-3 pointer',
                      pathname === '/' || pathname.includes(navlink.href)
                        ? 'active'
                        : ''
                      // pathname === navlink.href ? 'active' : ''
                    ...
                    <Link
                      href={navlink.href}
                      className='nav-link-mobile text-base'>
                      {navlink.label}
                    </Link>
                  </li>
                ))}
